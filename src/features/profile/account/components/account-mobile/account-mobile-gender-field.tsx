...
export function AccountMobileGenderField({
  label,
  value,
  onChange,
  maleLabel,
        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              className={
                selected
                  ? "flex h-12 items-center gap-2 rounded-sm border border-foreground bg-background px-3 text-foreground"
                  : "flex h-12 items-center gap-2 rounded-sm border border-transparent bg-secondary px-3 text-muted-foreground"
              }
            >
