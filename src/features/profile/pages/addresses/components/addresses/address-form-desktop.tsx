...
import {
  ...
  type IMapApi,
  type ICoords,
} from "@/features/profile/pages/addresses/components/address-map-mobile/yandex-map";
import {
  forwardGeocode,
  reverseGeocode,
  suggest,
  type ISuggestion,
} from "@/features/profile/pages/addresses/components/address-map-mobile/yandex-map-loader";
import {
  createAddressAction,
  deleteAddressAction,
  updateAddressAction,
