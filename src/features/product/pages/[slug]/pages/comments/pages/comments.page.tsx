...
import { CommentsMediaGallery } from "@/features/product/pages/[slug]/pages/comments/components/comments-media-gallery";
import { CommentsReviewList } from "@/features/product/pages/[slug]/pages/comments/components/comments-list/comments-review-list";
import { CommentsStickyBar } from "@/features/product/pages/[slug]/pages/comments/components/comments-sticky-bar";
import { CommentsMobilePage } from "@/features/product/pages/[slug]/pages/comments/components/comments-mobile/comments-mobile-page";
import { ratingDistributionMock } from "@/features/product/pages/[slug]/pages/comments/mocks/rating-distribution.mocks";
import { commentsReviewsMock } from "@/features/product/pages/[slug]/pages/comments/mocks/comments-reviews.mocks";
import {
  commentsMediaMock,
  commentsVideoIndex,
} from "@/features/product/pages/[slug]/pages/comments/mocks/comments-media.mocks";
