...
export const brands: IBrand[] = [
  ...
  { id: "b2", slug: "fashionrepublic", name: "Ryvang rens", image: brandImg(1), brandBg: "#1e3a8a", contents: brandContents(1) },
  { id: "b3", slug: "usem", name: "Usem", image: brandImg(2), brandBg: "#3f2a14", storyViewed: true, contents: brandContents(2) },
  { id: "b4", slug: "md", name: "MD", image: brandImg(3), brandBg: "#0f172a", contents: brandContents(3) },
  { id: "b5", slug: "vlack-cat", name: "Vlack cat", image: brandImg(4), brandBg: "#facc15", storyViewed: true, contents: brandContents(4) },
  { id: "b6", slug: "goodness", name: "Goodness", image: brandImg(5), brandBg: "#ea580c", contents: brandContents(0, 5) },
  { id: "b7", slug: "closet", name: "Closet", image: brandImg(6), brandBg: "#0a0a0a", contents: brandContents(1, 3) },
  { id: "b8", slug: "doyins", name: "Doyin's", image: brandImg(7), brandBg: "#14532d", storyViewed: true, contents: brandContents(2, 4) },
  ...
  { id: "b11", slug: "beal-2", name: "Beal", image: brandImg(10), brandBg: "#0a0a0a", storyViewed: true, contents: brandContents(0, 3) },
