import { FilterSection } from "@/components/common/listing/filter-sidebar/filter-section";
import { SizeFilter } from "@/components/common/listing/filter-sidebar/size-filter";
import { ColorFilter } from "@/components/common/listing/filter-sidebar/color-filter";
import {
  contentTypeFilterOptions,
  ratingFilterOptions,
} from "../../_lib/mocks/comments-filter.mocks";
